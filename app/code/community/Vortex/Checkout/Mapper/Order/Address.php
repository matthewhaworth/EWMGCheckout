<?php
class Vortex_Checkout_Mapper_Order_Address
{
    /**
     * @param $regionId
     * @return string
    ...
    /**
     * @param Mage_Sales_Model_Order_Address $quoteAddress
     * @return array
     */
    public function map(Mage_Sales_Model_Order_Address $quoteAddress)
    {
        $response = [
