export const config = window.ewmgCheckoutConfig || {
    postcodeAnywhere: {
        ...
        retrieveEndpoint: 'https://services.postcodeanywhere.co.uk/CapturePlus/Interactive/RetrieveFormatted/v2.10/json3ex.ws'
    },
    apiEndpoint: 'http://janenorman.co.uk.dev/fast-checkout/v1/api',
    magentoUrl: 'http://janenorman.co.uk.dev',
    worldpay: {
